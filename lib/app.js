...
var _riskOfRain = require("./risk-of-rain");
...
client.on('message', function (message) {
  ...
  if (command === '!ritem') {
    ...
    (0, _riskOfRain.getItem)(itemName).then(function (item) {
  ...
  if (command === '!rmonster') {
    ...
    (0, _riskOfRain.getMonster)(monsterName).then(function (monster) {
  ...
  if (command === '!rsurvivor') {
    ...
    (0, _riskOfRain.getSurvivor)(survivorName).then(function (survivor) {
      var embed = new _discord["default"].MessageEmbed();
