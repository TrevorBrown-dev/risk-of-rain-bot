...
var getMonster = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(monsterName) {
    var response, page, name, text, image;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            monsterName = (0, _spellCheck["default"])(monsterName, _db["default"].monsters);
            _context.next = 3;
            return _axios["default"].get("https://riskofrain2.gamepedia.com/".concat(monsterName))["catch"](function (error) {
              console.log(error);
            });
  ...
  return function getMonster(_x) {
    return _ref.apply(this, arguments);
  };
}();

var _default = getMonster;
