    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            itemName = (0, _spellCheck["default"])(itemName, _db["default"].items);
            _context.next = 3;
            return _axios["default"].get("https://riskofrain2.gamepedia.com/".concat(itemName));
          ...
          case 3:
            ...
            description = page.window.document.querySelector('.infoboxdesc').textContent;
